...
### Still not built
No real database (Neon isn't provisioned — Storage tab in Vercel dashboard, or ask to set one up next), no auth, Collections/Authors/Publishers/Series/Genres/Wishlist/Reading/Quotes/Notes/Timeline pages (still placeholders), no book detail page (clicking a book in Library does nothing yet), real AI Librarian, real Analytics, Search, import pipeline. This is still an early slice of an 11-phase spec — expect this to take many more sessions, similar to how her NEXORA Finance OS project took ~24 sessions.
