...
import { updateQuote } from "@/lib/quote-actions";
...
export function EditQuoteDialog({
  ...
  const [pageNumber, setPageNumber] = useState(initialPageNumber ? String(initialPageNumber) : "");
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
          ...
          <div className="glass relative max-h-[85vh] w-full max-w-md overflow-y-auto rounded-2xl border border-border/70 p-6 shadow-2xl">
            ...
            <form onSubmit={handleSubmit}>
              <h3 className="font-display mb-5 text-xl text-foreground">Edit Quote</h3>

              <div className="space-y-4">
                <p className="text-xs text-muted-foreground">
                  For <span className="text-foreground">{bookLabel}</span>
                </p>
