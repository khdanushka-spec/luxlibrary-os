...
export function EditNoteDialog({
  ...
  bookId?: string;
  books?: BookOption[];
  /** When set, the book picker is hidden and the note stays attached to this book (used on a Book Detail page). */
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
          ...
          <div className="glass relative max-h-[85vh] w-full max-w-md overflow-y-auto rounded-2xl border border-border/70 p-6 shadow-2xl">
            ...
            <form onSubmit={handleSubmit}>
              <h3 className="font-display mb-5 text-xl text-foreground">Edit Note</h3>
